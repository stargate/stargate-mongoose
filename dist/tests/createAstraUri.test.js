...
describe('Utils test', () => {
    ...
    it('with authHeaderName', () => {
        const apiEndpoint = 'https://a5cf1913-b80b-4f44-ab9f-a8b1c98469d0-ap-south-1.apps.astra.datastax.com';
        const uri = (0, createAstraUri_1.default)(apiEndpoint, 'myToken', 'testks1', 'apis', 'x-authn');
        assert_1.default.strictEqual(uri, 'https://a5cf1913-b80b-4f44-ab9f-a8b1c98469d0-ap-south-1.apps.astra.datastax.com/apis/testks1?applicationToken=myToken&authHeaderName=x-authn');
    });
});
