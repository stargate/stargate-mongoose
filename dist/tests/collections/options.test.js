...
describe('Options tests', async () => {
    ...
    describe('options cleanup tests', () => {
        ...
        it('should cleanup updateOneOptions', async () => {
            ...
            const updateOneResp = await mongooseFixtures_1.Product.updateOne({ name: 'Product 4' }, { $set: { isCertified: true }, $inc: { price: 5 } }, { upsert: true, rawResult: false, sort: { name: 1 } });
        ...
        it('should cleanup deleteOneOptions', async () => {
            ...
            await mongooseFixtures_1.Product.deleteOne({ name: 'Product 1' }, { runValidations: true });
