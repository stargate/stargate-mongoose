...
describe('tables', function () {
    it('createTable() and dropTable()', async function () {
        ...
        const tableNames = await mongooseFixtures_1.mongooseInstance.connection.listTables().then(tables => tables.map(t => t.name));
    ...
    it('schema indexes', async function () {
        ...
        await mongooseFixtures_1.mongooseInstance.connection.dropTable(TEST_TABLE_NAME);
        await mongooseFixtures_1.mongooseInstance.connection.createTable(TEST_TABLE_NAME, { primaryKey: '_id', columns: { _id: 'text', testProperty: 'text' } });
