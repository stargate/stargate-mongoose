...
export declare class Collection extends MongooseCollection {
     ...
     * @param callback
     */
    deleteOne(filter: Record<string, unknown>, options?: DeleteOneOptions, callback?: NodeCallback<CollectionDeleteOneResult | void>): Promise<void> | Promise<CollectionDeleteOneResult>;
    /**
 ...
 */
declare class AsyncCursorPlaceholder {
