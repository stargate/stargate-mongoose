...
export declare class Collection<DocType extends Record<string, unknown> = Record<string, unknown>> extends MongooseCollection {
     ...
     * @param options
     */
    findOne(filter: Record<string, unknown>, options?: FindOneOptions): Promise<DocType | null>;
    /**
     * Insert a single document into the collection.
     * @param doc
     */
    insertOne(doc: Record<string, unknown>): Promise<import("@datastax/astra-db-ts").CollectionInsertOneResult<import("@datastax/astra-db-ts").FoundDoc<import("@datastax/astra-db-ts").SomeDoc>>> | Promise<import("@datastax/astra-db-ts").TableInsertOneResult<Partial<import("@datastax/astra-db-ts").FoundRow<DocType>>>>;
    /**
     ...
     * @param options
     */
    findOneAndUpdate(filter: Record<string, unknown>, update: Record<string, unknown>, options: FindOneAndUpdateOptions): Promise<DocType | {
        value: DocType | null;
    } | null>;
    /**
     ...
     * @param options
     */
    findOneAndDelete(filter: Record<string, unknown>, options: FindOneAndDeleteOptions): Promise<DocType | {
        value: DocType | null;
    } | null>;
    /**
     ...
     * @param options
     */
    findOneAndReplace(filter: Record<string, unknown>, newDoc: Record<string, unknown>, options: FindOneAndReplaceOptions): Promise<DocType | {
        value: DocType | null;
    } | null>;
    /**
     ...
     * @param options
     */
    createVectorIndex(name: string, column: string, options?: {
