...
import { Collection as AstraCollection, DeleteOneOptions, DeleteOneResult, FindCursor, FindOneAndDeleteOptions, FindOneAndReplaceOptions, FindOneAndUpdateOptions, FindOneOptions, FindOptions, InsertManyResult, SortDirection, UpdateManyOptions, UpdateOneOptions } from '@datastax/astra-db-ts';
...
export declare class Collection extends MongooseCollection {
     ...
     * @param filter
     */
    deleteMany(filter: Record<string, unknown>): Promise<void> | Promise<import("@datastax/astra-db-ts").DeleteManyResult>;
    /**
