...
import { DeleteOneOptions, FindOneAndDeleteOptionsForDataAPI, FindOneAndReplaceOptionsForDataAPI, FindOneAndUpdateOptions, InsertManyOptions, UpdateManyOptions, FindOptionsForDataAPI, FindOneOptionsForDataAPI, ReplaceOneOptionsForDataAPI } from './options';
...
export declare class Collection {
    ...
    replaceOne(filter: Record<string, unknown>, replacement: Record<string, unknown>, options?: Record<string, unknown>): Promise<any>;
    updateOne(filter: Record<string, unknown>, update: Record<string, unknown>, options?: ReplaceOneOptionsForDataAPI): Promise<any>;
